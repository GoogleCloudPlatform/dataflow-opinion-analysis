...
public class PipelineCommand {
	...
	public static final String[] permittedCommands = new String[] {START_GCS_IMPORT,START_JDBC_IMPORT,START_PUBSUB_IMPORT, START_SOCIAL_IMPORT, START_STATS_CALC};

	public static final String[] documentImportCommands = new String[] {START_GCS_IMPORT,START_JDBC_IMPORT,START_PUBSUB_IMPORT};
